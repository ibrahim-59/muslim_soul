...
List<Map<String, dynamic>> ramadanDialogList = [
  {"title": AppStrings.ramadanAdvices, "type": RmadanType.advices},
  {"title": AppStrings.ramadanHealth, "type": RmadanType.health},
  {"title": AppStrings.ramadanAhkam, "type": RmadanType.ahkam},
  {"title": AppStrings.ramadanWays, "type": RmadanType.waysToFinishQuran},
  {"title": AppStrings.ramadanAd3ya, "type": RmadanType.ad3ya},
];

List<Map<String, dynamic>> hadithDialogList = [
  {"title": AppStrings.arb3on, "type": HaditType.arboon},
  {"title": AppStrings.muslim, "type": HaditType.muslim},
  {"title": AppStrings.bukhari, "type": HaditType.bukhari},
];

List<Map<String, dynamic>> adayaDialogList = [
  {"title": AppStrings.ad3yaQranya, "type": AdayaType.ad3yaQranya},
  {
    "title": AppStrings.ad3eyaKhatmAlQuran,
    "type": AdayaType.ad3eyaKhatmAlQuran
  },
  {"title": AppStrings.ad3yaAl3elm, "type": AdayaType.ad3yaAl3elm},
  {"title": AppStrings.ad3yaAlMtwafy, "type": AdayaType.ad3yaAlMtwafy},
  {"title": AppStrings.ad3yaAlrezq, "type": AdayaType.ad3yaAlrezq},
  {"title": AppStrings.ad3yaAltwba, "type": AdayaType.ad3yaNabwaya},
  {"title": AppStrings.ad3yaNabwaya, "type": AdayaType.ad3yaNabwaya},
  {"title": AppStrings.ad3yaZehabAlham, "type": AdayaType.ad3yaZehabAlham},
];

List<SebhaModel> sebhaList = [
  SebhaModel(content: "سبحان الله", count: 33, id: const Uuid().v4()),
  SebhaModel(content: "اللة أكبر", count: 33, id: const Uuid().v4()),
  SebhaModel(content: "الحمد لله", count: 33, id: const Uuid().v4()),
  SebhaModel(content: "لا اله الا الله", count: 100, id: const Uuid().v4()),
  SebhaModel(content: "أستغفر الله", count: 100, id: const Uuid().v4()),
  SebhaModel(
      content:
          "لا اله الا الله وحده لا شريك له له الملك وله الحمد وهو علي كل شئ قدير",
      count: 100,
      id: const Uuid().v4()),
  SebhaModel(content: "سبحان الله وبحمده", count: 100, id: const Uuid().v4()),
  SebhaModel(content: "سبحان الله العظيم", count: 100, id: const Uuid().v4()),
  SebhaModel(
      content: "اللهم صلي وسلم وبارك علي سيدنا مجمد",
      count: 100,
      id: const Uuid().v4()),
];
