...
class PlayButtonState extends State<PlayButton> with TickerProviderStateMixin {
  ...
  bool get _showWaves => !scaleController.isDismissed;

  void _updateRotation() => _rotation = rotationController.value * 2 * pi;
  void _updateScale() => _scale = (scaleController.value * 0.2) + 0.85;
